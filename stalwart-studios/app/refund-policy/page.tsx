    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-12">
          ...
          <h1 className="font-fraunces text-4xl font-semibold text-text-primary mb-4">Refund Policy</h1>
          <p className="text-text-secondary text-sm">Last updated: June 2025</p>
        </div>
        <div className="space-y-8 text-text-secondary text-sm leading-relaxed">
          <section>
            <h2 className="font-fraunces text-xl text-text-primary mb-3">Our Approach</h2>
          ...
          <section>
            <h2 className="font-fraunces text-xl text-text-primary mb-3">In-App Purchases & Subscriptions</h2>
          ...
          <section>
            <h2 className="font-fraunces text-xl text-text-primary mb-3">Exceptions</h2>
          ...
          <section>
            <h2 className="font-fraunces text-xl text-text-primary mb-3">How to Request a Refund</h2>
            <p>For any refund requests or billing questions, please email us at <a href="mailto:support@stalwartstudios.in" className="text-accent-gold hover:underline">support@stalwartstudios.in</a> with your order details. We typically respond within 1–2 business days.</p>
          </section>
        </div>
      </main>
    </div>
